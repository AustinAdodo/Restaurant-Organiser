...
namespace Restaurant_Menu_Organiser.Controllers
{
    public class SalesController : Controller
    {
        ...
        // GET: All Sales paginated , date sorting
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SumTotal,Quantity,Price,RestaurantName,orderPlacement,PaymentType,SaleDateandTime")] Sale sale)
        {
            if (id != sale.Id)
            {
                return NotFound();
